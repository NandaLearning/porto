    ...
    <div className=' mt-40' id='bussines'>
      <div className=' text-center'>
        ...
        <div className=' justify-center items-center flex'>
           <Link to="https://butuhweb.vercel.app/"><img src='butuh.PNG' className=' w-[300px] lg:w-[600px] md:w-[800px] mt-20 rounded-lg shadow-2xl drop-shadow-xl duration-200 shadow-purple-700'></img></Link>
        </div>
      </div>
    </div>
  )
