  ...
  return (
    <div className='p-10 mt-10 space-x-10'>
      <h1 className='text-white font-bold text-2xl font-sans md:text-4xl'>
        Welcome to the world of digital creativity!<br></br>I am{' '}
        <Link to='/' className='text-purple-700 font-bold'>
          Ananda Lukman Ramadhan,
        </Link>
        <br />a dedicated Fullstack Web Developer.
      </h1>
      <div className='grid justify-center mt-16 mx-20 md:grid-cols-2 md:gap-10'>
        ...
        <div>
          ...
          <p className='text-white text-xl mt-4'>
            ...
            mastering the art of web development has been evident throughout
            his learning journey.
          </p>
        <div className=' mt-7'>
          <h1 className='font-bold text-2xl text-white'>Lets Connect :</h1>
      ...
      <div className='mt-14'>
        ...
        <div className='flex justify-center flex-wrap md:space-x-10'>
